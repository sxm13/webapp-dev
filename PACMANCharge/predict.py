...
def predict_with_model(charge_name, file, name, digits, atom_type_option, neutral_option, connect_option):
    ...
    if charge_name=="DDEC6":
        charge_model_name = "./PACMANCharge/pth/best_ddec/ddec.pth"
        nor_name = "./PACMANCharge/pth/best_ddec/normalizer-ddec.pkl"
    elif charge_name=="Bader":
        charge_model_name = "./PACMANCharge/pth/best_bader/bader.pth"
        nor_name = "./PACMANCharge/pth/best_bader/normalizer-bader.pkl"
    elif charge_name=="CM5":
        charge_model_name = "./PACMANCharge/pth/best_cm5/cm5.pth"
        nor_name = "./PACMANCharge/pth/best_cm5/normalizer-cm5.pkl"
    elif charge_name=="REPEAT":
        charge_model_name = "./PACMANCharge/pth/best_repeat/repeat.pth"
        nor_name = "./PACMANCharge/pth/best_repeat/normalizer-repeat.pkl"
